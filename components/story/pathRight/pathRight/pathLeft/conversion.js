    ...
    return (
      <Fragment>
        <View style={{marginTop:"10%",width:"100%",flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor:"grey"}}>
          <Anime>
            <Text style={{color:"white",fontSize:15}}>{this.state.alias} asks the yellow deli employees about conversion.  {this.state.alias} is then immediately struck by lightnight and knocked unconscious.  {this.state.alias} wakes up at the 12 tribes commune. "how the hell did I get here?" {this.state.alias} thinks.  You are then approaced by Brother Ezikiel.  He offeres you a delicious sandwich and tells {this.state.alias} that they are welcome to join the 12 tribes commune if they abide by ALL the rules.</Text>
          </Anime>
        </View>
